...
def show_facilities_management():
    ...
    if locations_data:
        ...
        location_names = [f"{location['location_detail']} (ID: {location['location_id']})" for location in locations_data]
        ...
        if location_name_to_update:
            ...
            selected_location = next((location for location in locations_data if location['location_id'] == location_id_to_update), None)

            if selected_location:
                updated_location_detail = st.text_input("Updated Location Detail", value=selected_location['location_detail'])
