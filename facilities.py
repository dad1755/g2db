...
def show_facilities_management():
    ...
    # View Locations
    st.write("###### Location Available in Database")
    ...
    # Add Room
    st.write("###### Function To Add New Numbers Of Room in Cottage")
    ...
    # View Rooms
    st.write("###### Numbers Of Room Available In Database")
    rooms_data = get_rooms()
    if rooms_data:
        st.dataframe(rooms_data)

        # Update Room
        st.write("###### Function To Update Numbers of Room in Cottage")
        ...
        # Delete Room
        st.write("###### Function To Delete Number of Room in Cottage")
    ...
    # Add Maximum Pax
    st.write("###### Function to Add Maximum Pax for Cottage")
    ...
    # View Maximum Pax
    st.write("###### Maximum Pax List Available in Database")
    ...
    # View Cottage Types
    st.write("###### Cottage Type Avaulable in Database")
