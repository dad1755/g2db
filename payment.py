...
def show_payment_management():
    ...
    pt_details_input = st.text_input("Payment Type Details", key="pt_details_input")
    ...
    if payment_types_data:
        ...
        pt_id_to_delete_input = st.text_input("Enter Payment Type ID to delete", key="pt_id_to_delete_input")
    ...
    pay_details_input = st.text_input("Payment Status Details", key="pay_details_input")
    ...
    if payment_status_data:
        ...
        pay_id_to_delete_input = st.text_input("Enter Payment Status ID to delete", key="pay_id_to_delete_input")
