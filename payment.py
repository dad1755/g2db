...
def show_payment_management():
    ...
    pt_details_input = st.text_input("Payment Type Details", key="pt_details_input_56")  # Unique key using '56'
    if st.button("Add Payment Type", key="add_payment_type_button_56"):  # Unique key using '56'
        if pt_details_input:
    ...
    if payment_types_data:
        ...
        pt_id_to_delete_input = st.text_input("Enter Payment Type ID to delete", key="pt_id_to_delete_input_56")  # Unique key using '56'
        if st.button("Delete Payment Type", key="delete_payment_type_button_56"):  # Unique key using '56'
    ...
    pay_details_input = st.text_input("Payment Status Details", key="pay_details_input_status_56")  # Unique key using '56'
    if st.button("Add Payment Status", key="add_payment_status_button_56"):  # Unique key using '56'
    ...
    if payment_status_data:
        ...
        pay_id_to_delete_input = st.text_input("Enter Payment Status ID to delete", key="pay_id_to_delete_input_status_56")  # Unique key using '56'
        if st.button("Delete Payment Status", key="delete_payment_status_button_56"):  # Unique key using '56'
